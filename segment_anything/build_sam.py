...
def build_sam_vit_t(args):
    print('the image size and encoder adapter are not used in build_sam_vit_t, \
          as default image size is 1024 and encoder adapter is False')
